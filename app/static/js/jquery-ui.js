...
function Datepicker() {
	...
	this._defaults = { // Global defaults for all the date picker instances
		...
		defaultDate: "+0", // Used when field is blank: actual date,
		...
		yearRange: '-1:0' , // Range of years to display in drop-down,
		...
		maxDate: "0", // The latest selectable date, or null for no limit
	...
	this.regional["zh-CN"] = $.extend( true, {}, this.regional.en );
